  ...
  return {
    ...
    qualitySummary: {
      ...
      strategyCoverage: {
        ...
        matchedKeys: action === "observe" ? [] : ["kairosLowVolTrend"],
        matchedCandidateCount: action === "observe" ? 0 : 1,
        unmatchedCandidateCount: action === "observe" ? 1 : 0,
        dominantStrategyKey: action === "observe" ? null : "kairosLowVolTrend",
